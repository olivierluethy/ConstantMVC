<?php
/**
 * Navigation bar — the logo, wordmark and the "constant line" motif underneath.
 */
?>
<header class="border-b border-edge bg-panel/60 backdrop-blur">
    <nav class="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
        ...
        <span class="hidden font-mono text-xs uppercase tracking-widest text-slate-500 sm:block">
            PHP · MVC · single source of truth
        </span>
    </nav>
</header>
